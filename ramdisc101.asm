...
; ***************************************************************************************
.backup_command
    jmp prepare_for_next_command                                      ; 8133: 4c ee 82    L..
...
.initalise_file_system
    jsr toggle_control_bytes_switch_to_vector_page                    ; 81df: 20 f8 82     ..
; &81e2 referenced 1 time by &81dd
.c81e2
    jsr validate_control_byte_1_fcc1                                  ; 81e2: 20 83 81     ..
    beq should_i_print_banner                                         ; 81e5: f0 3e       .>
    pla                                                               ; 81e7: 68          h
    cmp #3                                                            ; 81e8: c9 03       ..
    beq is_ramdisc_turned_on                                          ; 81ea: f0 04       ..
    cmp #&27 ; '''                                                    ; 81ec: c9 27       .'
    bne pass_on_rom_service_call                                      ; 81ee: d0 15       ..
; ***************************************************************************************
; &81f0 referenced 1 time by &81ea
.is_ramdisc_turned_on
    jsr validate_rom_workspace                                        ; 81f0: 20 a4 81     ..
    beq pass_on_rom_service_call                                      ; 81f3: f0 10       ..             ; rom_workspace_byte_is_bb
    ldx #0                                                            ; 81f5: a2 00       ..
; ***************************************************************************************
...
.print_switched_off_banner
    ...
    inx                                                               ; 81fd: e8          .
    cpx #&1d                                                          ; 81fe: e0 1d       ..
    bne print_switched_off_banner                                     ; 8200: d0 f5       ..
...
.should_i_print_banner
    pla                                                               ; 8225: 68          h
    cmp #3                                                            ; 8226: c9 03       ..
    beq print_banner                                                  ; 8228: f0 07       ..
    cmp #&27 ; '''                                                    ; 822a: c9 27       .'
    beq print_banner                                                  ; 822c: f0 03       ..
    jmp check_for_unknown_osword                                      ; 822e: 4c a1 82    L..
...
.print_banner
    ...
    beq if_rom_autoboot                                               ; 8235: f0 5f       ._
    lda l0070                                                         ; 8237: a5 70       .p
    pha                                                               ; 8239: 48          H
    lda l0071                                                         ; 823a: a5 71       .q
    pha                                                               ; 823c: 48          H
    jsr print_inline_string                                           ; 823d: 20 de 83     ..            ; print inline string
    ...
    bcc invalid_drive_number                                          ; 8262: 90 04       ..
    cmp #&3a ; ':'                                                    ; 8264: c9 3a       .:
    bcc print_banner_drive_number                                     ; 8266: 90 1f       ..
; ***************************************************************************************
; &8268 referenced 1 time by &8262
.invalid_drive_number
    lda #&3f ; '?'                                                    ; 8268: a9 3f       .?
    bne print_banner_drive_number                                     ; 826a: d0 1b       ..             ; ALWAYS branch

; ***************************************************************************************
; &826c referenced 1 time by &825a
.print_unformatted
    jsr print_inline_string                                           ; 826c: 20 de 83     ..            ; print inline string
...
.print_banner_drive_number
    jsr oswrch                                                        ; 8287: 20 ee ff     ..            ; print_drive_number
    jsr osnewl                                                        ; 828a: 20 e7 ff     ..
    jsr osnewl                                                        ; 828d: 20 e7 ff     ..
    pla                                                               ; 8290: 68          h
...
.check_for_unknown_osword
    cmp #8                                                            ; 82a1: c9 08       ..
    bne check_for_vectors_changed                                     ; 82a3: d0 0e       ..
    ...
    tax                                                               ; 82ab: aa          .
    pla                                                               ; 82ac: 68          h
    bcc restore_status_flags_return_82b1                              ; 82ad: 90 02       ..
    lda #0                                                            ; 82af: a9 00       ..
; ***************************************************************************************
...
.check_for_vectors_changed
    cmp #&0f                                                          ; 82b3: c9 0f       ..
    bne check_for_unknowwn_star_command                               ; 82b5: d0 0a       ..
...
.check_for_unknowwn_star_command
    ...
    jsr check_for_command_with_leading_M                              ; 82c5: 20 7b 83     {.
...
.c82cd
    ...
    pha                                                               ; 82dd: 48          H
    lda command_table+1,x                                             ; 82de: bd 58 80    .X.
    pha                                                               ; 82e1: 48          H
    lda (os_text_ptr),y                                               ; 82e2: b1 f2       ..
    cmp #&2e ; '.'                                                    ; 82e4: c9 2e       ..             ; check for abreviation
...
.check_for_command_with_leading_M
    ...
    bne validate_command                                              ; 8382: d0 01       ..
    iny                                                               ; 8384: c8          .
; ***************************************************************************************
...
.loop_c8389
    ...
    tay                                                               ; 838a: a8          .
    pha                                                               ; 838b: 48          H
    jsr validate_command_line_char_is_alpha                           ; 838c: 20 ad 83     ..
...
.loop_c8392
    ...
    cmp #&ff                                                          ; 8398: c9 ff       ..
    beq end_of_command_tabel                                          ; 839a: f0 04       ..
    inx                                                               ; 839c: e8          .
    inx                                                               ; 839d: e8          .
...
.validate_command_line_char_is_alpha
    ...
    bcc reload_char_again                                             ; 83b3: 90 06       ..
    cmp #&5b ; '['                                                    ; 83b5: c9 5b       .[
    bcs reload_char_again                                             ; 83b7: b0 02       ..
...
.c83bd
    ...
    cmp #&21 ; '!'                                                    ; 83d1: c9 21       .!
    bcs validate_command_line_char_is_alpha                           ; 83d3: b0 d8       ..
...
.print_inline_string_get_next_char
    ...
    bne print_inline_string_no_page_boundary                          ; 83ea: d0 02       ..
...
.print_inline_string_no_page_boundary
    ...
    jsr osasci                                                        ; 83f7: 20 e3 ff     ..            ; string can contain vdu codes
    jsr restore_previously_saved_ramdisc_page                         ; 83fa: 20 90 87     ..
    jmp print_inline_string_get_next_char                             ; 83fd: 4c e6 83    L..
...
.put_error_string_on_stack
    ...
    bne put_error_string_on_stack                                     ; 8416: d0 f8       ..
    lda #&2e ; '.'                                                    ; 8418: a9 2e       ..             ; print two periods after error
    sta l0100,y                                                       ; 841a: 99 00 01    ...
    sta l0101,y                                                       ; 841d: 99 01 01    ...
    lda #0                                                            ; 8420: a9 00       ..             ; insert final brk
    sta l0102,y                                                       ; 8422: 99 02 01    ...
    jsr restore_zp_variables_from_ramdisc_variables_page_00fe         ; 8425: 20 17 87     ..
    jmp l0100                                                         ; 8428: 4c 00 01    L..            ; invoke brk handler
...
.validate_filename
    ...
    nop                                                               ; 843e: ea          .
    nop                                                               ; 843f: ea          .
    lda lfd3e                                                         ; 8440: ad 3e fd    .>.            ; directory letter
    sta l0087                                                         ; 8443: 85 87       ..
    ldy #0                                                            ; 8445: a0 00       ..
    jsr skip_over_spaces_in_command_line                              ; 8447: 20 c8 84     ..
    cmp #&0d                                                          ; 844a: c9 0d       ..
    bne file_name_on_command_line                                     ; 844c: d0 03       ..
...
.file_name_on_command_line
    cmp #&22 ; '"'                                                    ; 8451: c9 22       ."
    bne validate_drive_number                                         ; 8453: d0 0a       ..
    jsr get_next_character                                            ; 8455: 20 d1 84     ..
    cmp #&22 ; '"'                                                    ; 8458: c9 22       ."
    bne validate_drive_number                                         ; 845a: d0 03       ..
...
.validate_drive_number
    ...
    jsr get_next_character                                            ; 8463: 20 d1 84     ..
    sta l0088                                                         ; 8466: 85 88       ..
    cmp #&30 ; '0'                                                    ; 8468: c9 30       .0
    bcc jump_to_error_bad_drive                                       ; 846a: 90 09       ..
    cmp ramdisc_drive_number                                          ; 846c: cd 13 fd    ...
    beq valid_drive_number                                            ; 846f: f0 07       ..
    cmp #&34 ; '4'                                                    ; 8471: c9 34       .4
    bcc valid_drive_number                                            ; 8473: 90 03       ..
; ***************************************************************************************
...
.valid_drive_number
    jsr get_next_character                                            ; 8478: 20 d1 84     ..
    cmp #&2e ; '.'                                                    ; 847b: c9 2e       ..
    bne jump_to_error_bad_drive                                       ; 847d: d0 f6       ..
    iny                                                               ; 847f: c8          .
; &8480 referenced 1 time by &8461
.c8480
    dey                                                               ; 8480: 88          .
    jsr get_next_character                                            ; 8481: 20 d1 84     ..
    tax                                                               ; 8484: aa          .
    jsr get_next_character                                            ; 8485: 20 d1 84     ..
    cmp #&2e ; '.'                                                    ; 8488: c9 2e       ..
    bne assume_directory_from_current_selected_directory              ; 848a: d0 05       ..
    txa                                                               ; 848c: 8a          .
    iny                                                               ; 848d: c8          .
    jmp strip_bit_8_from_ascii                                        ; 848e: 4c 95 84    L..

; ***************************************************************************************
; &8491 referenced 1 time by &848a
.assume_directory_from_current_selected_directory
    lda lfd3e                                                         ; 8491: ad 3e fd    .>.            ; current_selected_directory
    dey                                                               ; 8494: 88          .
; ***************************************************************************************
; &8495 referenced 1 time by &848e
.strip_bit_8_from_ascii
    and #&7f                                                          ; 8495: 29 7f       ).             ; strip bit 7 for ASCII
    sta l0087                                                         ; 8497: 85 87       ..
    ldx #0                                                            ; 8499: a2 00       ..
; &849b referenced 1 time by &84b6
.loop_c849b
    lda (ptr2),y                                                      ; 849b: b1 8b       ..
    cmp #&0d                                                          ; 849d: c9 0d       ..
...
.c84a9
    cmp #&20 ; ' '                                                    ; 84a9: c9 20       .
    bne store_filename_in_zp                                          ; 84ab: d0 01       ..
    dey                                                               ; 84ad: 88          .
; ***************************************************************************************
; &84ae referenced 1 time by &84ab
.store_filename_in_zp
    and #&7f                                                          ; 84ae: 29 7f       ).             ; clear bit 7 for ASCII
...
.skip_over_spaces_check_for_more
    iny                                                               ; 84c9: c8          .
    lda (ptr2),y                                                      ; 84ca: b1 8b       ..
    cmp #&20 ; ' '                                                    ; 84cc: c9 20       .
    beq skip_over_spaces_check_for_more                               ; 84ce: f0 f9       ..
    rts                                                               ; 84d0: 60          `
...
.sub_c84d5
    ...
    lda sub_drive_number                                              ; 84d8: ad 56 fd    .V.
...
.get_char_of_catalogue_filename
    ...
    bne filename_is_populated                                         ; 84eb: d0 03       ..
    jmp c8580                                                         ; 84ed: 4c 80 85    L..

; ***************************************************************************************
; &84f0 referenced 1 time by &84eb
.filename_is_populated
    cmp l0080,x                                                       ; 84f0: d5 80       ..             ; check if filename chars match
    beq filenames_match_so_far                                        ; 84f2: f0 12       ..
    jsr filename_is_ascii                                             ; 84f4: 20 8e 85     ..
    bcs c8574                                                         ; 84f7: b0 7b       .{
    sta l0075                                                         ; 84f9: 85 75       .u
    lda l0080,x                                                       ; 84fb: b5 80       ..
    jsr filename_is_ascii                                             ; 84fd: 20 8e 85     ..
...
.c8574
    ...
    bne jump_to_c84e6                                                 ; 8577: d0 12       ..
    jsr enough_catalogue_pages_left                                   ; 8579: 20 17 88     ..
    bcc jump_to_c84e6                                                 ; 857c: 90 0d       ..
    lda #1                                                            ; 857e: a9 01       ..
...
.jump_to_c84e6
    jmp check_for_empty_catalogue                                     ; 858b: 4c e6 84    L..
...
.filename_is_ascii
    ...
    bcc set_carry_and_return_859e                                     ; 8590: 90 0c       ..
    cmp #&7b ; '{'                                                    ; 8592: c9 7b       .{
    bcs set_carry_and_return_859e                                     ; 8594: b0 08       ..
    ora #&20 ; ' '                                                    ; 8596: 09 20       .
    cmp #&40 ; '@'                                                    ; 8598: c9 40       .@
    beq set_carry_and_return_859e                                     ; 859a: f0 02       ..
    clc                                                               ; 859c: 18          .
    rts                                                               ; 859d: 60          `
...
.sub_c85a0
    ...
    bne filename_entry_found                                          ; 85a3: d0 04       ..
...
.filename_entry_found
    ...
    beq deal_with_wildcards                                           ; 85cf: f0 1c       ..
    lda l0087                                                         ; 85d1: a5 87       ..
    cmp #&2a ; '*'                                                    ; 85d3: c9 2a       .*
    beq deal_with_wildcards                                           ; 85d5: f0 16       ..
    cmp #&23 ; '#'                                                    ; 85d7: c9 23       .#
    beq deal_with_wildcards                                           ; 85d9: f0 12       ..
    jsr filename_is_ascii                                             ; 85db: 20 8e 85     ..
    bcs load_a_zero_clear_carry_return                                ; 85de: b0 43       .C
    sta l007c                                                         ; 85e0: 85 7c       .|
    lda l0071                                                         ; 85e2: a5 71       .q
    jsr filename_is_ascii                                             ; 85e4: 20 8e 85     ..
    bcs load_a_zero_clear_carry_return                                ; 85e7: b0 3a       .:
    cmp l007c                                                         ; 85e9: c5 7c       .|
    bne load_a_zero_clear_carry_return                                ; 85eb: d0 36       .6
; ***************************************************************************************
...
.c85ef
    ...
    jsr filename_is_ascii                                             ; 85fe: 20 8e 85     ..
    bcs load_a_zero_clear_carry_return                                ; 8601: b0 20       .
    sta l007c                                                         ; 8603: 85 7c       .|
    lda jim,y                                                         ; 8605: b9 00 fd    ...
    jsr filename_is_ascii                                             ; 8608: 20 8e 85     ..
    bcs load_a_zero_clear_carry_return                                ; 860b: b0 16       ..
    cmp l007c                                                         ; 860d: c5 7c       .|
    bne load_a_zero_clear_carry_return                                ; 860f: d0 12       ..
...
.c8617
    ...
    ror a                                                             ; 861b: 6a          j
    bcc transfer_x_to_a_clear_carry_return                            ; 861c: 90 02       ..
    inx                                                               ; 861e: e8          .              ; X=&02
    inx                                                               ; 861f: e8          .              ; X=&03
; ***************************************************************************************
...
.sub_c8627
    tya                                                               ; 8627: 98          .
    pha                                                               ; 8628: 48          H
    lda l0071                                                         ; 8629: a5 71       .q             ; directory name?
    and #&7f                                                          ; 862b: 29 7f       ).             ; mask off top bit
    jsr store_current_ramdisc_page                                    ; 862d: 20 83 87     ..
    jsr oswrch                                                        ; 8630: 20 ee ff     ..
    lda #&2e ; '.'                                                    ; 8633: a9 2e       ..
    jsr oswrch                                                        ; 8635: 20 ee ff     ..            ; print full stop between directory and filename
...
.c8678
    ...
    sbc #5                                                            ; 867d: e9 05       ..
    tay                                                               ; 867f: a8          .
    jsr print_hex_word_from_ramdisc                                   ; 8680: 20 c2 86     ..
    tya                                                               ; 8683: 98          .
    clc                                                               ; 8684: 18          .
    adc #7                                                            ; 8685: 69 07       i.
    tay                                                               ; 8687: a8          .
    jsr print_hex_word_from_ramdisc                                   ; 8688: 20 c2 86     ..
    inc lsb_ramdisc_page                                              ; 868b: ee c0 fc    ...
    dey                                                               ; 868e: 88          .
    jsr print_hex_word_from_ramdisc                                   ; 868f: 20 c2 86     ..
    tya                                                               ; 8692: 98          .
    clc                                                               ; 8693: 18          .
    adc #6                                                            ; 8694: 69 06       i.
    tay                                                               ; 8696: a8          .
    ...
    jsr osnewl                                                        ; 86b2: 20 e7 ff     ..
    jsr restore_previously_saved_ramdisc_page                         ; 86b5: 20 90 87     ..
; &86b8 referenced 1 time by &86ad
.c86b8
    bit os_escape_flag                                                ; 86b8: 24 ff       $.
    bmi escape_as_pressed                                             ; 86ba: 30 03       0.
    pla                                                               ; 86bc: 68          h
    tay                                                               ; 86bd: a8          .
    rts                                                               ; 86be: 60          `
...
.write_zp_variables_to_ramdisc
    ...
    dex                                                               ; 870d: ca          .
    bpl write_zp_variables_to_ramdisc                                 ; 870e: 10 f8       ..
...
.not_a_digit
    beq get_next_character_from_command_line                          ; 87c7: f0 02       ..
    sec                                                               ; 87c9: 38          8
    rts                                                               ; 87ca: 60          `
...
.check_hex_for_subdrive
    ...
    bcc jump_to_error_bad_drive2                                      ; 87df: 90 0c       ..
    cmp #&47 ; 'G'                                                    ; 87e1: c9 47       .G
    bcs jump_to_error_bad_drive2                                      ; 87e3: b0 08       ..
    cmp #&3a ; ':'                                                    ; 87e5: c9 3a       .:
...
.check_hex_for_digit
    ...
    cmp #&3a ; ':'                                                    ; 87f5: c9 3a       .:
    bcs check_hex_for_valid_char                                      ; 87f7: b0 06       ..
    sec                                                               ; 87f9: 38          8
...
.pop_return_address
    pla                                                               ; 882e: 68          h
    pla                                                               ; 882f: 68          h
    jmp prepare_for_next_command                                      ; 8830: 4c ee 82    L..
...
.help_title_or_extended
    ...
    cmp #&0d                                                          ; 885e: c9 0d       ..
    bne print_extended_help_text                                      ; 8860: d0 0c       ..
    ldx #&ff                                                          ; 8862: a2 ff       ..
; ***************************************************************************************
...
.loop_c8870
    ...
    cmp #&2e ; '.'                                                    ; 8872: c9 2e       ..             ; check users_help_command
    beq print_all_help                                                ; 8874: f0 0d       ..
    and #&df                                                          ; 8876: 29 df       ).
...
.print_all_help
    jsr osnewl                                                        ; 8883: 20 e7 ff     ..
    ldx #0                                                            ; 8886: a2 00       ..
; &8888 referenced 1 time by &8893
.loop_c8888
    lda title,x                                                       ; 8888: bd 09 80    ...
    cmp #&28 ; '('                                                    ; 888b: c9 28       .(
    beq print_extended_help                                           ; 888d: f0 06       ..
...
.sub_c89d3
    ...
    jsr save_extended_vectors_to_ramdisc_vector_page                  ; 89dd: 20 ee 89     ..
...
.copy_original_extended_vectors_to_ramdisc_vector_page
    ...
    bne copy_original_extended_vectors_to_ramdisc_vector_page         ; 8a13: d0 f5       ..
    ldx #0                                                            ; 8a15: a2 00       ..
    ldy #&1b                                                          ; 8a17: a0 1b       ..
; &8a19 referenced 1 time by &8a2e
.install_ramdisc_vectors_in_extended_vectors_table
    lda new_extended_vector_table,x                                   ; 8a19: bd 38 8a    .8.
    sta (l0070),y                                                     ; 8a1c: 91 70       .p
    inx                                                               ; 8a1e: e8          .
    iny                                                               ; 8a1f: c8          .
    lda new_extended_vector_table,x                                   ; 8a20: bd 38 8a    .8.
    ...
    bne install_ramdisc_vectors_in_extended_vectors_table             ; 8a2e: d0 e9       ..
    pla                                                               ; 8a30: 68          h
...
.c8a5a
    ...
    sta ptr2                                                          ; 8a5f: 85 8b       ..
    lda #&8a                                                          ; 8a61: a9 8a       ..
    sta ptr2+1                                                        ; 8a63: 85 8c       ..
    jsr validate_filename                                             ; 8a65: 20 36 84     6.
...
.check_if_file_exists
    ...
    jsr print_inline_string                                           ; 8a73: 20 de 83     ..            ; print inline string
...
.loop_c8aed
    iny                                                               ; 8aed: c8          .
    lda vector_table_entries,y                                        ; 8aee: b9 18 8b    ...
...
.sub_c8b30
    ...
    jsr copy_ptr_008e_to_ptr2                                         ; 8b3d: 20 2b 84     +.
...
.c8b4b
    ...
    jsr copy_ptr_008e_to_ptr2                                         ; 8b4f: 20 2b 84     +.
...
.c8b5d
    jsr copy_ptr_008e_to_ptr2                                         ; 8b5d: 20 2b 84     +.
...
.c8d49
    ...
    cmp free_sector_count+1                                           ; 8d4e: c5 b3       ..
    bcc c8d88                                                         ; 8d50: 90 36       .6
    bne c8d5c                                                         ; 8d52: d0 08       ..
    lda l007a                                                         ; 8d54: a5 7a       .z
    cmp free_sector_count                                             ; 8d56: c5 b2       ..
...
.c8d77
    ...
    jmp error_catalogue_full                                          ; 8d85: 4c b8 8d    L..
...
.c8d88
    ...
    nop                                                               ; 8da4: ea          .
    lda free_sector_count                                             ; 8da5: a5 b2       ..
    sta lfd6a                                                         ; 8da7: 8d 6a fd    .j.
    nop                                                               ; 8daa: ea          .
    lda free_sector_count+1                                           ; 8dab: a5 b3       ..
...
.loop_c8dfb
    ...
    sta free_sector_count                                             ; 8e1f: 85 b2       ..
    iny                                                               ; 8e21: c8          .
    nop                                                               ; 8e22: ea          .
    lda jim,y                                                         ; 8e23: b9 00 fd    ...
    sta free_sector_count+1                                           ; 8e26: 85 b3       ..
    lda l0077                                                         ; 8e28: a5 77       .w
    beq update_ramdisc_free_sector_count                              ; 8e2a: f0 1a       ..             ; updates the free sector count
    ...
    sta free_sector_count                                             ; 8e39: 85 b2       ..
    lda lfd69                                                         ; 8e3b: ad 69 fd    .i.
    nop                                                               ; 8e3e: ea          .
    nop                                                               ; 8e3f: ea          .
    nop                                                               ; 8e40: ea          .
    adc lfd6b                                                         ; 8e41: 6d 6b fd    mk.
    sta free_sector_count+1                                           ; 8e44: 85 b3       ..
; ***************************************************************************************
...
.update_ramdisc_free_sector_count
    sec                                                               ; 8e46: 38          8
    lda free_sector_count                                             ; 8e47: a5 b2       ..
    sbc l00b0                                                         ; 8e49: e5 b0       ..
    sta free_sector_count                                             ; 8e4b: 85 b2       ..
    lda free_sector_count+1                                           ; 8e4d: a5 b3       ..
    sbc l00b1                                                         ; 8e4f: e5 b1       ..
    sta free_sector_count+1                                           ; 8e51: 85 b3       ..
    rts                                                               ; 8e53: 60          `
...
.sub_c8e68
    ...
    jsr check_for_tube                                                ; 8e6f: 20 e1 9c     ..            ; check if tube present
    beq tube_is_active                                                ; 8e72: f0 06       ..
    lda l0074                                                         ; 8e74: a5 74       .t
    and #&80                                                          ; 8e76: 29 80       ).             ; set_tube_present_flag
...
.tube_is_active
    ...
    bmi tube_present_flag_set                                         ; 8e80: 30 19       0.
...
.tube_present_flag_set
    ...
    ror a                                                             ; 8ea1: 6a          j
    bcc c8ea9                                                         ; 8ea2: 90 05       ..             ; check if the tube present flag is set
    lda #0                                                            ; 8ea4: a9 00       ..
...
.sub_c900a
    ...
    nop                                                               ; 9010: ea          .
    lda sub_drive_number                                              ; 9011: ad 56 fd    .V.
    pha                                                               ; 9014: 48          H
...
.c90ac
    ldx single_byte_table_4_value_3                                   ; 90ac: ae 69 90    .i.
...
.sub_c90b2
    ...
    tya                                                               ; 90b3: 98          .
    pha                                                               ; 90b4: 48          H
    jsr switch_to_file_pointer_page_00ff                              ; 90b5: 20 f0 99     ..
    txa                                                               ; 90b8: 8a          .
    pha                                                               ; 90b9: 48          H
...
.c926a
    ...
    bne check_if_file_locked                                          ; 927d: d0 03       ..
...
.c93f2
    ...
    bcc discard_return_address_change_to_file_pointer_page_00ff       ; 93f6: 90 0a       ..
    bne c940c                                                         ; 93f8: d0 12       ..
    lda l0080                                                         ; 93fa: a5 80       ..
    cmp l0082                                                         ; 93fc: c5 82       ..
    bcc discard_return_address_change_to_file_pointer_page_00ff       ; 93fe: 90 02       ..
...
.c9460
    ...
    tya                                                               ; 9462: 98          .
    pha                                                               ; 9463: 48          H
    ldx single_byte_table_2_value_0c                                  ; 9464: ae 55 94    .U.
...
.c95e7
    ...
    lda sub_drive_number                                              ; 95ef: ad 56 fd    .V.
...
.c9681
    ...
    jsr enough_catalogue_pages_left                                   ; 9688: 20 17 88     ..
...
.c96f5
    ...
    jsr check_for_tube                                                ; 9704: 20 e1 9c     ..            ; check if tube present
...
.sub_c9711
    ...
    jsr switch_to_file_pointer_page_00ff                              ; 9727: 20 f0 99     ..
    lda #1                                                            ; 972a: a9 01       ..
...
.c9732
    ...
    jsr switch_to_file_pointer_page_00ff                              ; 973a: 20 f0 99     ..
    ...
    jsr switch_to_file_pointer_page_00ff                              ; 974b: 20 f0 99     ..
    lda #0                                                            ; 974e: a9 00       ..
...
.c9756
    jsr switch_to_file_pointer_page_00ff                              ; 9756: 20 f0 99     ..
    lda #0                                                            ; 9759: a9 00       ..
    sta lfdfc                                                         ; 975b: 8d fc fd    ...
    ldx l008e                                                         ; 975e: a6 8e       ..
    stx ptr2                                                          ; 9760: 86 8b       ..
    ldy l008f                                                         ; 9762: a4 8f       ..
    sty ptr2+1                                                        ; 9764: 84 8c       ..
    jsr validate_filename                                             ; 9766: 20 36 84     6.
...
.c97ec
    ...
    ldx single_byte_table_6_value_0f                                  ; 97ef: ae 10 97    ...
...
.c9802
    ...
    pha                                                               ; 9805: 48          H
    jsr switch_to_file_pointer_page_00ff                              ; 9806: 20 f0 99     ..
    ldx #0                                                            ; 9809: a2 00       ..
    txa                                                               ; 980b: 8a          .              ; A=&00
    pha                                                               ; 980c: 48          H
; ***************************************************************************************
...
.check_next_file_handle
    ldy file_pointer_offsets,x                                        ; 980d: bc 5e 98    .^.
; ***************************************************************************************
; &9810 referenced 1 time by &981b
.check_handle_filename
    lda jim,y                                                         ; 9810: b9 00 fd    ...
    cmp l0080,x                                                       ; 9813: d5 80       ..             ; check filenames match
    bne filename_check_fails                                          ; 9815: d0 16       ..
    iny                                                               ; 9817: c8          .
    inx                                                               ; 9818: e8          .
    cpx #8                                                            ; 9819: e0 08       ..             ; filename and directory letter
    bne check_handle_filename                                         ; 981b: d0 f3       ..
.sub_c981d
l981e = sub_c981d+1
    lda lfd04,y                                                       ; 981d: b9 04 fd    ...
; &981e referenced 4 times by &90ba, &91c6, &9277, &9abd
    cmp #&40 ; '@'                                                    ; 9820: c9 40       .@
    bne jump_to_error_file_open                                       ; 9822: d0 db       ..
    pla                                                               ; 9824: 68          h
    pla                                                               ; 9825: 68          h
...
.filename_check_fails
    ...
    inx                                                               ; 982f: e8          .
    cpx #5                                                            ; 9830: e0 05       ..
    bne check_next_file_handle                                        ; 9832: d0 d9       ..
...
.c9846
    ...
    jsr switch_to_file_pointer_page_00ff                              ; 9849: 20 f0 99     ..
    ldx #0                                                            ; 984c: a2 00       ..
; &984e referenced 1 time by &9859
.loop_c984e
    ldy file_pointer_offsets,x                                        ; 984e: bc 5e 98    .^.
...
.sub_c98e6
    jsr switch_to_file_pointer_page_00ff                              ; 98e6: 20 f0 99     ..
    tya                                                               ; 98e9: 98          .
    and #&bf                                                          ; 98ea: 29 bf       ).             ; mask off bit 7
    tay                                                               ; 98ec: a8          .
    lda file_pointer_offsets,y                                        ; 98ed: b9 5e 98    .^.
    tay                                                               ; 98f0: a8          .
...
.loop_through_file_handles
    ...
    bcc loop_through_file_handles                                     ; 99ed: 90 f3       ..
    rts                                                               ; 99ef: 60          `
...
.sub_c99fe
    ...
    cmp #8                                                            ; 9a0a: c9 08       ..
    bcc update_boot_option                                            ; 9a0c: 90 5d       .]
...
.write_boot_option_text_to_drive
    lda boot_option_text,y                                            ; 9a97: b9 57 9a    .W.
    sta lfd2b,x                                                       ; 9a9a: 9d 2b fd    .+.            ; write_text_to_ramdrive
    iny                                                               ; 9a9d: c8          .
    inx                                                               ; 9a9e: e8          .
    cpx #5                                                            ; 9a9f: e0 05       ..
...
.c9aba
    jsr switch_to_file_pointer_page_00ff                              ; 9aba: 20 f0 99     ..
...
.c9ad8
    ...
    ldy #0                                                            ; 9ae8: a0 00       ..
    jsr check_for_command_with_leading_M                              ; 9aea: 20 7b 83     {.
...
.c9afc
    ...
    sta ptr2+1                                                        ; 9b04: 85 8c       ..
    jsr validate_filename                                             ; 9b06: 20 36 84     6.
...
.c9b0e
    ...
    jsr check_for_tube                                                ; 9b27: 20 e1 9c     ..            ; check if tube present
...
.c9ba3
    ...
    lda sub_drive_number                                              ; 9ba5: ad 56 fd    .V.
...
.c9c6c
    ...
    jsr enough_catalogue_pages_left                                   ; 9c76: 20 17 88     ..
...
.c9cb9
    ...
    ldx single_byte_table_3_value_12                                  ; 9cbc: ae fd 99    ...
...
.sub_c9ced
    ...
    bmi tube_present_flag_still_set                                   ; 9cef: 30 0d       0.
...
.c9d08
    ...
    jsr tube_delay_loop                                               ; 9d17: 20 2a 9d     *.
    rts                                                               ; 9d1a: 60          `
...
.loop_c9d1e
    pha                                                               ; 9d1e: 48          H
    jsr tube_delay_loop                                               ; 9d1f: 20 2a 9d     *.
    pla                                                               ; 9d22: 68          h
    rts                                                               ; 9d23: 60          `
...
.access_command
    ...
    jsr move_ptr_to_after_command                                     ; 9d37: 20 4e 88     N.
    dey                                                               ; 9d3a: 88          .
; ***************************************************************************************
...
.find_end_of_access_command
    ...
    cmp #&0d                                                          ; 9d3e: c9 0d       ..
    bne find_end_of_access_command                                    ; 9d40: d0 f9       ..
; ***************************************************************************************
...
.remove_spaces_at_end_of_access_command
    ...
    cmp #&20 ; ' '                                                    ; 9d45: c9 20       .
    beq remove_spaces_at_end_of_access_command                        ; 9d47: f0 f9       ..
    and #&df                                                          ; 9d49: 29 df       ).
    sta l0075                                                         ; 9d4b: 85 75       .u
    jsr validate_filename                                             ; 9d4d: 20 36 84     6.
    beq c9d55                                                         ; 9d50: f0 03       ..
    jmp prepare_for_next_command                                      ; 9d52: 4c ee 82    L..

; &9d55 referenced 1 time by &9d50
.c9d55
    jsr switch_to_ramdisc_variable_page_00fe                          ; 9d55: 20 f3 86     ..
    lda sub_drive_number                                              ; 9d58: ad 56 fd    .V.
...
.c9d7e
    ...
    jsr enough_catalogue_pages_left                                   ; 9d83: 20 17 88     ..
    bcc c9d66                                                         ; 9d86: 90 de       ..
; &9d88 referenced 1 time by &9d69
.c9d88
    lda l0074                                                         ; 9d88: a5 74       .t
    beq jump_to_error_file_not_found                                  ; 9d8a: f0 03       ..
    jmp command_finished                                              ; 9d8c: 4c ea 82    L..
...
.compact_command
    ...
    jsr check_for_a_digit                                             ; 9db7: 20 bb 87     ..
    cmp #&0d                                                          ; 9dba: c9 0d       ..
...
.c9dc4
    ...
    beq print_compact_are_you_sure                                    ; 9dc7: f0 03       ..
    jmp prepare_for_next_command                                      ; 9dc9: 4c ee 82    L..

; ***************************************************************************************
; &9dcc referenced 1 time by &9dc7
.print_compact_are_you_sure
    jsr print_inline_string                                           ; 9dcc: 20 de 83     ..            ; print inline string
    equs "Compact: Are you sure ? "                                   ; 9dcf: 43 6f 6d... Com
    equb &ea                                                          ; 9de7: ea          .

    jsr get_user_response                                             ; 9de8: 20 0a a1     ..
    beq c9df0                                                         ; 9deb: f0 03       ..
    jmp command_finished                                              ; 9ded: 4c ea 82    L..
...
.c9e70
    ...
    jsr enough_catalogue_pages_left                                   ; 9e75: 20 17 88     ..
...
.loop_c9ff0
    ...
    pla                                                               ; a01e: 68          h
    clc                                                               ; a01f: 18          .
    adc ptr2                                                          ; a020: 65 8b       e.
    sta l0082                                                         ; a022: 85 82       ..
    nop                                                               ; a024: ea          .
    nop                                                               ; a025: ea          .
    nop                                                               ; a026: ea          .
    lda l0083                                                         ; a027: a5 83       ..
    adc ptr2+1                                                        ; a029: 65 8c       e.
    nop                                                               ; a02b: ea          .
    nop                                                               ; a02c: ea          .
...
.delete_command
    ...
    jsr move_ptr_to_after_command                                     ; a03e: 20 4e 88     N.
    jsr validate_filename                                             ; a041: 20 36 84     6.
    beq delete_command_find_filename                                  ; a044: f0 03       ..
    jmp prepare_for_next_command                                      ; a046: 4c ee 82    L..

; ***************************************************************************************
; &a049 referenced 1 time by &a044
.delete_command_find_filename
    jsr sub_c84d5                                                     ; a049: 20 d5 84     ..
    bcc delete_command_file_is_locked                                 ; a04c: 90 03       ..
    jmp error_file_not_found                                          ; a04e: 4c 41 81    LA.

; ***************************************************************************************
; &a051 referenced 1 time by &a04c
.delete_command_file_is_locked
    bpl delete_command_file_found                                     ; a051: 10 03       ..
...
.destroy_command
    ...
    jsr move_ptr_to_after_command                                     ; a06f: 20 4e 88     N.
    jsr validate_filename                                             ; a072: 20 36 84     6.
    beq ca07a                                                         ; a075: f0 03       ..
    jmp prepare_for_next_command                                      ; a077: 4c ee 82    L..

; &a07a referenced 1 time by &a075
.ca07a
    jsr switch_to_ramdisc_variable_page_00fe                          ; a07a: 20 f3 86     ..
    lda sub_drive_number                                              ; a07d: ad 56 fd    .V.
...
.get_user_response
    ...
    bne print_user_response                                           ; a11a: d0 03       ..
...
.dir_command
    ...
    jmp prepare_for_next_command                                      ; a14d: 4c ee 82    L..
...
.ca150
    ...
    iny                                                               ; a157: c8          .
    jsr check_for_a_digit                                             ; a158: 20 bb 87     ..
...
.ca187
    ...
    jmp prepare_for_next_command                                      ; a190: 4c ee 82    L..
...
.drive_command
    ...
    jsr check_for_a_digit                                             ; a1a8: 20 bb 87     ..
...
.ca1ba
    ...
    jmp prepare_for_next_command                                      ; a1bd: 4c ee 82    L..
...
.info_command
    ...
    jsr move_ptr_to_after_command                                     ; a1d1: 20 4e 88     N.
    jsr validate_filename                                             ; a1d4: 20 36 84     6.
    beq ca1dc                                                         ; a1d7: f0 03       ..
    jmp prepare_for_next_command                                      ; a1d9: 4c ee 82    L..

; &a1dc referenced 1 time by &a1d7
.ca1dc
    jsr sub_ca1e2                                                     ; a1dc: 20 e2 a1     ..
    jmp command_finished                                              ; a1df: 4c ea 82    L..

; &a1e2 referenced 2 times by &9a51, &a1dc
.sub_ca1e2
    jsr switch_to_ramdisc_variable_page_00fe                          ; a1e2: 20 f3 86     ..
    lda sub_drive_number                                              ; a1e5: ad 56 fd    .V.
...
.ca20d
    ...
    jsr enough_catalogue_pages_left                                   ; a212: 20 17 88     ..
...
.lib_command
    ...
    jmp prepare_for_next_command                                      ; a22d: 4c ee 82    L..
...
.rename_command
    ...
    jsr move_ptr_to_after_command                                     ; a24e: 20 4e 88     N.
    jsr validate_filename                                             ; a251: 20 36 84     6.
    beq ca259                                                         ; a254: f0 03       ..
    jmp prepare_for_next_command                                      ; a256: 4c ee 82    L..
...
.loop_ca279
    ...
    iny                                                               ; a284: c8          .
    jsr move_ptr_to_after_command                                     ; a285: 20 4e 88     N.
    jsr validate_filename                                             ; a288: 20 36 84     6.
...
.loop_ca29a
    ...
    jmp command_finished                                              ; a2a5: 4c ea 82    L..
...
.title_command
    ...
    jmp prepare_for_next_command                                      ; a2f0: 4c ee 82    L..
...
.ca32e
    cpx #&0c                                                          ; a32e: e0 0c       ..
    beq jump_to_command_finished                                      ; a330: f0 08       ..
    lda #&20 ; ' '                                                    ; a332: a9 20       .
...
.jump_to_command_finished
    jmp command_finished                                              ; a33a: 4c ea 82    L..

; ***************************************************************************************
.wipe_command
    jsr check_if_drive_formatted                                      ; a33d: 20 23 88     #.
    jsr move_ptr_to_after_command                                     ; a340: 20 4e 88     N.
    jsr validate_filename                                             ; a343: 20 36 84     6.
    beq ca34b                                                         ; a346: f0 03       ..
    jmp prepare_for_next_command                                      ; a348: 4c ee 82    L..

; &a34b referenced 1 time by &a346
.ca34b
    jsr switch_to_ramdisc_variable_page_00fe                          ; a34b: 20 f3 86     ..
    lda sub_drive_number                                              ; a34e: ad 56 fd    .V.
...
.sub_ca38c
    ...
    jsr get_user_response                                             ; a3a3: 20 0a a1     ..
...
.cfind_command
    ...
    jsr move_ptr_to_after_command                                     ; a3c7: 20 4e 88     N.
    jsr validate_filename                                             ; a3ca: 20 36 84     6.
...
.ca3d8
    ...
    pha                                                               ; a3ea: 48          H
    jsr print_inline_string                                           ; a3eb: 20 de 83     ..            ; print inline string
    ...
    jsr print_inline_string                                           ; a404: 20 de 83     ..            ; print inline string
...
.ca418
    ...
    jsr enough_catalogue_pages_left                                   ; a41d: 20 17 88     ..
...
.ca429
    jmp command_finished                                              ; a429: 4c ea 82    L..
...
.ca438
    ...
    jmp command_finished                                              ; a43b: 4c ea 82    L..

; ***************************************************************************************
.ramform_command
    jsr print_inline_string                                           ; a43e: 20 de 83     ..            ; print inline string
    equs "Format the Ramdisc: Are you sure ? "                        ; a441: 46 6f 72... For
    equb &ea                                                          ; a464: ea          .

    jsr get_user_response                                             ; a465: 20 0a a1     ..
    beq user_confirmed_format                                         ; a468: f0 03       ..
    jmp command_finished                                              ; a46a: 4c ea 82    L..
...
.loop_ca47b
    ...
    nop                                                               ; a48d: ea          .
    nop                                                               ; a48e: ea          .
    stx sub_drive_number                                              ; a48f: 8e 56 fd    .V.
    nop                                                               ; a492: ea          .
    nop                                                               ; a493: ea          .
...
.loop_ca4f3
    ...
    jmp command_finished                                              ; a4fa: 4c ea 82    L..
...
.rdrive_command
    ...
    jsr check_for_a_digit                                             ; a553: 20 bb 87     ..
...
.ca55b
    ...
    jmp command_finished                                              ; a563: 4c ea 82    L..

; ***************************************************************************************
; &a566 referenced 1 time by &9ede
.rstat_command
    jsr check_if_drive_formatted_show_error                           ; a566: 20 33 88     3.
    jsr print_inline_string                                           ; a569: 20 de 83     ..            ; print inline string
...
.loop_ca5a6
    ...
    jsr print_inline_string                                           ; a5bc: 20 de 83     ..            ; print inline string
    equb &0d                                                          ; a5bf: 0d          .
    ...
    jsr print_inline_string                                           ; a5dd: 20 de 83     ..            ; print inline string
    equs "  Maximum &0A80"                                            ; a5e0: 20 20 4d...   M
    equb &0d, &ea                                                     ; a5ef: 0d ea       ..

    jsr print_inline_string                                           ; a5f1: 20 de 83     ..            ; print inline string
    ...
    jsr print_inline_string                                           ; a616: 20 de 83     ..            ; print inline string
    equb &0d                                                          ; a619: 0d          .
    ...
    jmp command_finished                                              ; a63c: 4c ea 82    L..
...
.rtest_command
    ...
    jsr print_inline_string                                           ; a656: 20 de 83     ..            ; print inline string
    ...
    pla                                                               ; a685: 68          h
    cmp #2                                                            ; a686: c9 02       ..
    bne rtest_print_header                                            ; a688: d0 01       ..
    inx                                                               ; a68a: e8          .              ; X=&32
; ***************************************************************************************
...
.rtest_print_header
    ...
    jsr print_inline_string                                           ; a69a: 20 de 83     ..            ; print inline string
    equs "000 sectors ("                                              ; a69d: 30 30 30... 000
    equb &ea                                                          ; a6aa: ea          .

    pla                                                               ; a6ab: 68          h
    jsr oswrch                                                        ; a6ac: 20 ee ff     ..            ; Write character
    jsr print_inline_string                                           ; a6af: 20 de 83     ..            ; print inline string
...
.rtest_write_test_and_compare
    ...
    bne rtest_write_failure                                           ; a6f9: d0 14       ..
    nop                                                               ; a6fb: ea          .
    lda #&ff                                                          ; a6fc: a9 ff       ..
...
.ca712
    ...
    inx                                                               ; a719: e8          .
    bne rtest_write_test_and_compare                                  ; a71a: d0 c7       ..
    lda l0085                                                         ; a71c: a5 85       ..
    beq rtest_check_for_escape_increment_sector                       ; a71e: f0 03       ..
...
.rtest_check_for_escape_increment_sector
    ...
    jmp rtest_start_of_test_from_page_0000                            ; a737: 4c be a6    L..
...
.loop_ca747
    ...
    jsr print_inline_string                                           ; a74f: 20 de 83     ..            ; print inline string
...
.rtest_write_error_check_for_space
    ...
    bne rtest_write_error_check_for_space                             ; a76e: d0 f0       ..
    lda #9                                                            ; a770: a9 09       ..
    jsr oswrch                                                        ; a772: 20 ee ff     ..            ; tab
...
.rtest_write_error_print_space
    ...
    dex                                                               ; a783: ca          .
    cpx #&21 ; '!'                                                    ; a784: e0 21       .!
    bne rtest_write_error_print_space                                 ; a786: d0 f8       ..
    beq rtest_write_error_check_for_space                             ; a788: f0 d6       ..             ; ALWAYS branch
...
.ca7f1
    ...
    cpx #0                                                            ; a7f3: e0 00       ..
    bne scan_command_print_searching_ram                              ; a7f5: d0 0f       ..
...
.scan_command_print_searching_ram
    jsr print_inline_string                                           ; a806: 20 de 83     ..            ; print inline string
...
.subdrive_command
    ...
    jsr check_hex_for_subdrive                                        ; a8b8: 20 da 87     ..
    tax                                                               ; a8bb: aa          .
    iny                                                               ; a8bc: c8          .
    jsr ignore_spaces_in_command_line                                 ; a8bd: 20 d1 87     ..
    cmp #&0d                                                          ; a8c0: c9 0d       ..
    beq ca8d3                                                         ; a8c2: f0 0f       ..
    jsr check_hex_for_subdrive                                        ; a8c4: 20 da 87     ..
...
.ca8de
    ...
    jsr check_hex_for_digit                                           ; a8e4: 20 f1 87     ..
    asl a                                                             ; a8e7: 0a          .
    asl a                                                             ; a8e8: 0a          .
    asl a                                                             ; a8e9: 0a          .
    asl a                                                             ; a8ea: 0a          .
    ...
    jsr check_hex_for_digit                                           ; a8f0: 20 f1 87     ..
    clc                                                               ; a8f3: 18          .
    adc l0070                                                         ; a8f4: 65 70       ep
    sta sub_drive_number                                              ; a8f6: 8d 56 fd    .V.
    jmp command_finished                                              ; a8f9: 4c ea 82    L..
...
.ca902
    ...
    jmp command_finished                                              ; a905: 4c ea 82    L..
...
.unwipe_command
    ...
    jsr move_ptr_to_after_command                                     ; a923: 20 4e 88     N.
    jsr validate_filename                                             ; a926: 20 36 84     6.
    beq ca92e                                                         ; a929: f0 03       ..
    jmp command_finished                                              ; a92b: 4c ea 82    L..

; &a92e referenced 1 time by &a929
.ca92e
    jsr switch_to_ramdisc_variable_page_00fe                          ; a92e: 20 f3 86     ..
    lda sub_drive_number                                              ; a931: ad 56 fd    .V.
...
.ca9ba
    jsr get_user_response                                             ; a9ba: 20 0a a1     ..
...
.redit_command
    ...
    jsr draw_redit_screen                                             ; a9e8: 20 3b ad     ;.
...
.ca9ee
    ...
    ldx #0                                                            ; a9f6: a2 00       ..
    jsr print_redit_instructions                                      ; a9f8: 20 30 ad     0.
...
.ca9fe
    ...
    jsr print_hex                                                     ; aa0f: 20 18 ad     ..
    lda l0070                                                         ; aa12: a5 70       .p
    jsr print_hex                                                     ; aa14: 20 18 ad     ..
    ldx #&0b                                                          ; aa17: a2 0b       ..
    ldy #4                                                            ; aa19: a0 04       ..
...
.caaa8
    ...
    jsr print_redit_instructions                                      ; aac2: 20 30 ad     0.
...
.sub_cab19
    ...
    ldx #&81                                                          ; ab1e: a2 81       ..
    jsr print_redit_instructions                                      ; ab20: 20 30 ad     0.
    ldx #&0a                                                          ; ab23: a2 0a       ..
...
.sub_cabec
    ...
    lda sub_drive_number                                              ; ac0a: ad 56 fd    .V.
    jsr print_hex                                                     ; ac0d: 20 18 ad     ..
...
.print_hex
    ...
    lsr a                                                             ; ad1b: 4a          J
    lsr a                                                             ; ad1c: 4a          J
    jsr print_hex_nibble                                              ; ad1d: 20 23 ad     #.
    pla                                                               ; ad20: 68          h
    and #&0f                                                          ; ad21: 29 0f       ).
; ***************************************************************************************
...
.print_hex_nibble
    ...
    cmp #&3a ; ':'                                                    ; ad26: c9 3a       .:
    bcc print_hex_jmp_oswrch                                          ; ad28: 90 03       ..
    clc                                                               ; ad2a: 18          .
    adc #7                                                            ; ad2b: 69 07       i.
; ***************************************************************************************
...
.fill_rest_of_vdu_command
    ...
    dex                                                               ; af17: ca          .
    bne fill_rest_of_vdu_command                                      ; af18: d0 fa       ..
    rts                                                               ; af1a: 60          `
...
.copy_command
    ...
    jmp prepare_for_next_command                                      ; af98: 4c ee 82    L..
...
.print_ramdisc
    jsr print_inline_string                                           ; afa7: 20 de 83     ..            ; print inline string
...
.cafb6
    jsr print_inline_string                                           ; afb6: 20 de 83     ..            ; print inline string
...
.cafd7
    jsr print_inline_string                                           ; afd7: 20 de 83     ..            ; print inline string
...
.cafee
    ...
    jsr move_ptr_to_after_command                                     ; aff0: 20 4e 88     N.
    jsr validate_filename                                             ; aff3: 20 36 84     6.
    lda l007b                                                         ; aff6: a5 7b       .{
    cmp l0079                                                         ; aff8: c5 79       .y
    beq cb002                                                         ; affa: f0 06       ..
    jsr sub_cb019                                                     ; affc: 20 19 b0     ..
    jmp command_finished                                              ; afff: 4c ea 82    L..

; &b002 referenced 1 time by &affa
.cb002
    jsr sub_cb2d8                                                     ; b002: 20 d8 b2     ..
    jmp command_finished                                              ; b005: 4c ea 82    L..
...
.sub_cb2d8
    ...
    lda sub_drive_number                                              ; b2db: ad 56 fd    .V.
...
.cb2ff
    ...
    jsr enough_catalogue_pages_left                                   ; b304: 20 17 88     ..
...
.cb41b
    ...
    jmp error_catalogue_full                                          ; b422: 4c b8 8d    L..
...
; ***************************************************************************************
.fback_command
    jsr check_for_a_digit                                             ; b71c: 20 bb 87     ..
...
.cb72e
    ...
    jsr print_inline_string                                           ; b733: 20 de 83     ..            ; print inline string
...
.cb7ad
    ...
    jsr print_inline_string                                           ; b7b0: 20 de 83     ..            ; print inline string
...
.loop_cb808
    ...
    jsr print_inline_string                                           ; b824: 20 de 83     ..            ; print inline string
    equb &0d                                                          ; b827: 0d          .
...
.error_crc_error_detected
    jsr print_inline_string                                           ; b865: 20 de 83     ..            ; print inline string
...
.print_another_copy
    jsr print_inline_string                                           ; b87d: 20 de 83     ..            ; print inline string
...
.print_disc_in_drive
    jsr print_inline_string                                           ; b8b8: 20 de 83     ..            ; print inline string
...
; ***************************************************************************************
.ramload_command
    jsr print_inline_string                                           ; b9eb: 20 de 83     ..            ; print inline string
...
.cba24
    ...
    jmp command_finished                                              ; ba27: 4c ea 82    L..
...
.ramsave_command
    ...
    jsr print_inline_string                                           ; ba3a: 20 de 83     ..            ; print inline string
...
.cba77
    ...
    jsr print_inline_string                                           ; ba79: 20 de 83     ..            ; print inline string
    equb &0d                                                          ; ba7c: 0d          .
...
.cbacd
    ...
    jmp command_finished                                              ; bad0: 4c ea 82    L..
...
.sub_cbbcc
    jsr print_inline_string                                           ; bbcc: 20 de 83     ..            ; print inline string
    equb &0d                                                          ; bbcf: 0d          .
...
.press_space_to_continue
    jsr print_inline_string                                           ; bc04: 20 de 83     ..            ; print inline string
    equb &0d                                                          ; bc07: 0d          .
...
.sub_cbc35
    jsr print_inline_string                                           ; bc35: 20 de 83     ..            ; print inline string
...
.text_END
    ...
    equb 0                                                            ; bc76: 00          .
    equb &20, &98, &18, &69, 8, &a8, &e8, &e0, 8, &d0, &ea, &60       ; bc77: 20 98 18...  ..
...
.print_insert_backup_disc_number
    jsr print_inline_string                                           ; bccc: 20 de 83     ..            ; print inline string
    equb &0d                                                          ; bccf: 0d          .
...
;     Data                     = 2948 bytes (18%)
;
;     Number of instructions   = 6534
;     Number of data bytes     = 1233 bytes
